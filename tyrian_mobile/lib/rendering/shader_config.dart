...
class ShaderConfig {
  ...
  static const defaults = <String, ShaderConfig>{
    ...
    'luftrausers': ShaderConfig(
      vignetteRadius: 0.4, vignetteSoft: 0.4,
